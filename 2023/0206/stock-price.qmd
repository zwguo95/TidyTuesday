---
title: "Tech Company Stock Price"
format: html
editor: visual
---
...
ggplot(aes(x = stock_index, y = return)) + 
  ...
  labs(x = "", y = "Percentage of Quarterly Stock Returns",
       title = "STOCK COLLAPSE OF BIG TECHS",
       subtitle = " ",
       caption = str_wrap("Data comes from Yahoo Finance via Kaggle, collected and shared by Evan Gower | Visualization by Zhaowen Guo", width = 300)) +
